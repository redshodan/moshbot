...
import org.codepunks.moshbot.bean.PortForwardBean;
...
import org.codepunks.moshbot.service.TerminalManager.KeyHolder;
...
//		pubkey.setType(PubkeyDatabase.KEY_TYPE_IMPORTED);
	...
	/* (non-Javadoc)
	 * @see org.codepunks.moshbot.transport.AbsTransport#usesNetwork()
	 */
	@Override
