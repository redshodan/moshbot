...
@Config(constants = BuildConfig.class, sdk = Build.VERSION_CODES.KITKAT, packageName = "org.codepunks.moshbot")
public class HostListActivityTest {
	private void mockBindToService(TerminalManager terminalManager) {
		...
		shadowOf(RuntimeEnvironment.application).setComponentNameAndServiceForBindService(new ComponentName("org.codepunks.moshbot", TerminalManager.class.getName()), stubBinder);
	}
